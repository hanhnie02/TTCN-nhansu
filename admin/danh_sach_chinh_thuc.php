                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div>
                   ...
                   <table class="table table-bordered">
                      ...
                      $sql = "
                      SELECT * 
                      FROM tblungvien a join tbltuyenpv b on  b.mauv=a.MaUV join tbldspvan c on b.mapv=c.mapv
                       join tblphongvan d on c.mapv=d.MaPV join tbldsthuviec e on d.MaTV=e.matv
                       join tblloc f on e.matv=f.MaTV join tbldsnhanvienchinhthuc g on f.MaTV=g.MaTV
                      where f.Ketqua='Đạt';
                      "; 
