...
<?php
	...
	if(isset($_POST['dangnhap'])) {
		...
		{
			$sql_select_admin = mysqli_query($conn,"SELECT * FROM tblquanly WHERE TKQL='$taikhoan' AND matkhau='$matkhau' LIMIT 1");
...
<html lang="en">
  <head>
    ...
    <title>T&T |Trang đăng nhập </title>
      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            ...
            <br><br>
             <h1 style="color: black"><b>Hệ thống quản trị T&T</b></h1>
              <div>
