                   ...
                   <table class="table table-bordered">
                      ...
                      ;?>
                        ...
                        <tr>
                          ...
                          <td><?php echo $row["luongthuviec"];?></td>
                          <td><?php echo $row["luongchinhthuc"];?></td>
                          <td><?php echo $row["vitriUT"];?></td>
                          <td><?php echo $row["quyenloi"];?></td>
                          <td><?php echo $row["chitietcv"];?></td>
                          <td><?php echo $row["yeucau"];?></td>
                          <td><a href="admin-sua.php?id_nd=<?php echo $row['MaMT'];?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
                          <td><a href="admin-xoa.php?id_nd=<?php echo $row['MaMT'];?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></td>
                        </tr>
                      <?php
                      }
                      ;?>
