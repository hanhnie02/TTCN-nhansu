                   ...
                   <table class="table table-bordered">
                      ...
                      ;?>
                        ...
                        <tr>
                          ...
                          <td><?php echo $row["TKQL"];?></td>
                          <td><?php echo $row["matkhau"];?></td>
                      
                          <td><a href="admin-sua.php?id_nd=<?php echo $row['TKQL'];?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
                          <td><a href="admin-xoa.php?id_nd=<?php echo $row['TKQL'];?>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></td>
                        </tr>
                      <?php
                      }
                      ;?>
